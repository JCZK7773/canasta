...
def the_draw_2(current_player, testing = False): # ****
    ...
    if current_player.name == 'Player 1' or current_player.name == 'Player 2': # ****
        while True: # ****
            try: # ****
                ...
                game.progr_text(current_player, text, True)
                ...
                game.Game.progr_text(current_player, text) # ****
    ...
    while True: # ****
        try: # ****
            ...
            game.Game.progr_text(current_player, text, False, True)
...
def play_1(current_player): # ****
    ...
    while True: # ****
        try: # ****
            ...
            game.Game.progr_text(current_player, text, has_input = True)
